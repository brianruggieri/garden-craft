          ...
          <>
            <section>
              ...
              <div className="space-y-3">
                {veggieTypes
                  .filter((vType) => !["Oregano", "Thyme", "Sage"].includes(vType))
                  .map((vType) => {
                  const seed = seeds.find((s) => s.type === vType);
                  ...
                  return (
                    <div
                      key={vType}
                      className="bg-white rounded-lg px-3 py-2 border border-slate-200 transition-all hover:border-emerald-300 hover:shadow-sm"
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-[10px] font-black text-slate-400 w-4 text-right">
                          {priority}
                        </span>
                      </div>

                      {isEditing && (
                        <div className="mt-2 pt-2 border-t border-slate-200 space-y-2 animate-in slide-in-from-top-2 duration-200">
